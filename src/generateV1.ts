...
const waitForNextBlock = async () => {
    ...
    console.log(`Fantasy token height: ${state.bestTokenHeight}`);
...
export const generateV1 = async () => {
    ...
    console.log(`Blockchain height: ${state.bestBlockchainHeight}`);
    console.log(`Fantasy height: ${state.bestTokenHeight}`);
    ...
    if (process.env.USE_FASTMINE === "yes") {
        ...
        while (keepTrying) {
            ...
            console.log("Please wait, mining for Fantasy (using fastmine)...");
        ...
        console.log("Please wait, mining for Fantasy (not using fastmine)...");
